          ...
          <div className="lg:col-span-2 bg-white border border-[#E1E5E3] rounded-lg p-6 shadow-[0_2px_8px_rgba(0,0,0,0.015)] flex flex-col justify-between">
            <div>
              ...
              <div className="relative pl-6 space-y-8 before:absolute before:left-[7px] before:top-2 before:bottom-2 before:w-[2px] before:bg-[#E1E5E3]">
                ...
                {/* STEP 3: VERIFICATION */}
                <div className="relative">
                  <span className="absolute -left-[25px] top-0.5 bg-white rounded-full p-px text-[#1A73E8]">
                    <span className="w-[14px] h-[14px] block rounded-full border-2 border-[#1A73E8] border-t-transparent animate-spin" />
                  </span>
                  <div className="flex justify-between items-start gap-4">
                    <div>
                      <h4 className="text-[15px] font-bold text-[#1A73E8]">Verification in Progress</h4>
                      <p className="text-[13px] text-[#5F6368] mt-0.5">Expected completion by Oct 30, 2025</p>
                    </div>
                    <RefreshCw size={18} className="text-[#1A73E8] animate-spin shrink-0" />
                  </div>
                </div>
