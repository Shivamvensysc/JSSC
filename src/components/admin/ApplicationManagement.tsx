...
//         {/* LEFT SIDEBAR */}
//         <div className="w-[320px] rounded border border-[#b8c2bd] bg-[#f3f5f4] shadow-sm">
//           {/* Header */}
//           <div className="flex items-center justify-between border-b border-[#cfd6d2] bg-[#e7ece9] px-4 py-3">
//             <div className="flex items-center gap-2">
//               <span className="text-[15px] font-semibold text-[#2b3b37]">
//                 Candidates
//               </span>

//               <div className="rounded bg-[#2d7d69] px-2 py-[2px] text-[10px] font-semibold text-white">
//                 12 Results
//               </div>
//             </div>

//             <Search size={15} className="text-[#53635d]" />
//           </div>
...
//               <div
//                 key={index}
//                 className={`rounded border px-3 py-3 transition-all ${
//                   candidate.active
//                     ? "border-[#2d7d69] bg-white shadow-sm"
//                     : "border-[#d8dede] bg-[#fbfbfb]"
//                 }`}
//               >
//                 <div className="mb-2 flex items-center justify-between">
//                   <p className="text-[10px] font-semibold tracking-wide text-[#6d7a75]">
//                     {candidate.id}
//                   </p>
...
//                 <h3 className="text-[15px] font-semibold leading-5 text-[#22312d]">
//                   {candidate.name}
//                 </h3>

//                 <div className="mt-3 space-y-1">
//                   <div className="flex items-center gap-2 text-[11px] text-[#6f7d78]">
//                     <Mail size={12} />
...
//               <button className="flex h-[38px] items-center gap-2 rounded border border-[#bfc9c5] bg-white px-4 text-[13px] font-semibold text-[#33413d] shadow-sm">
//                 <Printer size={15} />
//                 Print
//               </button>

//               <button className="flex h-[38px] items-center gap-2 rounded bg-[#136a4b] px-4 text-[13px] font-semibold text-white shadow-sm">
//                 <Pencil size={15} />
//                 Edit Profile
//               </button>
//             </div>
...
//                   {/* Image */}
//                   <div className="h-[130px] w-[110px] overflow-hidden rounded border border-[#d6dcdc] bg-[#eef2ef]">
//                     <img
...
//                   <button className="text-[13px] font-medium text-[#2c6e57]">
...
//                 <h2 className="mt-3 text-[36px] font-bold">₹1,200.00</h2>
  ...
  return (
    <div className="min-h-screen font-sans bg-[#F4F5F7]  px-4">
      <div className="mx-auto flex max-w-7xl gap-4">
        ...
        {/* LEFT SIDEBAR */}
        <div className="w-[320px] rounded border border-[#b8c2bd] bg-[#f3f5f4] shadow-sm shrink-0">
          {/* Header */}
          <div className="flex items-center justify-between border-b border-[#cfd6d2] bg-[#e7ece9] px-4 py-3">
            <div className="flex items-center gap-2">
              <span className="text-[15px] font-semibold text-[#2b3b37]">
