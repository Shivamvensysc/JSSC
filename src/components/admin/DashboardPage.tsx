...
//     totalPages: 1
//   });
//   const [dateRange, setDateRange] = useState<string>("24-11-2023");
...
//   const getStatusBadge = (application?: Application): StatusBadge => {
//     if (!application) {
...
//     } else if (application.status === "draft" && application.currentStep && application.currentStep > 0) {
...
//   const getVerificationBadge = (candidate: Candidate): StatusBadge => {
